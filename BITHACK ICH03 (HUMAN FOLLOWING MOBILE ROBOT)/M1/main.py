...
Known_distance =20.5 # Inches
#mine is 14.3 something, measure your face width, asre google it 
Known_width=14.5 #Inches
...
Arduino = serial.Serial(baudrate=9600, port ='COM8')      
...
while True:
    ...
    for (face_x, face_y, face_w, face_h) in Faces:
        if face_width_in_frame !=0:
            ...
            elif Distance >40 and Distance<=200:
                # Writing The motor Speed 
